...
void tab_page_hp_bars::initialize_hp_bar_options()
{
...
void tab_page_hp_bars::fillShowHpModeComboxOptions(std::shared_ptr<nana::combox>& combox)
{
...
void tab_page_hp_bars::fillHpBarColorModeComboxOptions(std::shared_ptr<nana::combox>& combox)
{
...
void tab_page_hp_bars::fillHpBarColorComboxOptions(std::shared_ptr<nana::combox>& combox)
{
...
void tab_page_hp_bars::on_cb_enableHpBarOptions_checked()
{
    enableHpBarOptions();
    update();
}

void tab_page_hp_bars::enableHpBarOptions()
{
...
void tab_page_hp_bars::disableHpBarOptions()
{
...
void tab_page_hp_bars::make_editable()
{
...
void tab_page_hp_bars::make_readonly()
{
