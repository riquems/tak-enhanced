...
void tab_page_mods::initialize_checkboxes()
{
...
void tab_page_mods::desactivate_listboxes()
{
...
void tab_page_mods::desactivate_buttons()
{
...
void tab_page_mods::activate_listboxes()
{
...
void tab_page_mods::activate_buttons()
{
...
void tab_page_mods::initialize_listbox1()
{
...
void tab_page_mods::load_listbox1()
{
...
void tab_page_mods::initialize_listbox2()
{
...
void tab_page_mods::load_listbox2()
{
...
void tab_page_mods::move_items(nana::listbox::index_pairs items, std::shared_ptr<nana::listbox> source, std::shared_ptr<nana::listbox> dest)
{
...
void tab_page_mods::initialize_buttons()
{
...
std::vector<std::string> tab_page_mods::get_selected_mods()
{
    std::vector<std::string> selected_mods;

    nana::listbox::index_pairs selected_mods_index_pairs = this->lb_listbox2->items();

    for (nana::listbox::index_pair selected_mod_index_pairs : selected_mods_index_pairs) {
        std::string selected_mod_filename = this->lb_listbox2->at(selected_mod_index_pairs).text(0);
...
void tab_page_mods::make_readonly()
{
...
void tab_page_mods::make_editable()
{
